...
if __name__ == "__main__":
    ...
    if scheduling_algorithm == "partitioned":
        ...
        if partition_is_possible:
            ...
            def simulate_processor(processor: Processor, synchronous_taskset: TaskSet):
                ...
                return NewBool.from_bool(schedulePassed)
    ...
    # The rest of the code for "global" and "edf(k)" remains unchanged...
